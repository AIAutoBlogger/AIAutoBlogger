...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Subscribe button functionality - now links directly to Shopify App Store
    // No additional JavaScript needed as the link handles the navigation
    ...
    if (shopifyBtn) {
        shopifyBtn.addEventListener('click', function() {
            // Redirect to AI Auto Blogger on Shopify App Store
            window.open('https://apps.shopify.com/ai-auto-blogger-1', '_blank');
        });
    }
